  ...
  function r(e){
    ...
    var f=$("header .menu-btn"),l=$("header nav"),c=$("header .nav-bg"),h=$("body, html"),u=$(window),p=$("main"),b=$("#modal"),m=0,g=0;e(),n($(".motion-trigger"),location.hash),setTimeout(function(){
      u.scrollTop(u.scrollTop()+1)},100),a(location.hash),"#deletecookie"==location.hash&&b.length>0&&$.removeCookie("firstmodal"),_ua.PC?(0==b.length||$.cookie("firstmodal"))&&r(location.pathname):r(location.pathname),f.on("click",function(){
        ...
        $(".motion-trigger").one("inview",function(){$(this).parent().addClass("inviewed")}),$("body").on("click",".sns a",function(){
          return $(this).parent().hasClass("tw")?d(this,560,450):s(this.href,560,600),!1}),$("#modal, #modal .close").on("click",function(){
            r()
          })
        });
        var _ua=function(e){
          var t={0:e.indexOf("windows")!=-1&&e.indexOf("phone")!=-1||e.indexOf("iphone")!=-1||e.indexOf("ipod")!=-1||e.indexOf("android")!=-1&&e.indexOf("mobile")!=-1||e.indexOf("firefox")!=-1&&e.indexOf("mobile")!=-1||e.indexOf("blackberry")!=-1,iPhone:e.indexOf("iphone")!=-1,Android:e.indexOf("android")!=-1&&e.indexOf("mobile")!=-1},i=e.indexOf("windows")!=-1&&e.indexOf("touch")!=-1||e.indexOf("ipad")!=-1||e.indexOf("android")!=-1&&e.indexOf("mobile")==-1||e.indexOf("firefox")!=-1&&e.indexOf("tablet")!=-1||e.indexOf("kindle")!=-1||e.indexOf("silk")!=-1||e.indexOf("playbook")!=-1,o=!t[0]&&!i;return{Mobile:t,Tablet:i,PC:o}
        }
